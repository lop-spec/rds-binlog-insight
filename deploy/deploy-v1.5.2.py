...
NEW_IMAGE = "local/rds-binlog-insight:1.5.2"
BACKUP_IMAGE = "local/rds-binlog-insight:backup-v1.5.1-pre-v1.5.2"
RESULT_FILE = ROOT / "deploy-v1.5.2-result.json"
SOURCE_FILES = (
    ".dockerignore",
    ".env.example",
    "Dockerfile",
...
def main() -> int:
    ...
    staging = (ROOT / ".deploy-v1.5.2-staging").resolve()
    ...
    try:
        ...
        activated = True
        current_health = wait_health("1.5.2")
