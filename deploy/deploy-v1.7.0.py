...
NEW_IMAGE = "local/rds-binlog-insight:1.7.0"
BACKUP_IMAGE = "local/rds-binlog-insight:backup-v1.6.4-pre-v1.7.0"
RESULT_FILE = ROOT / "deploy-v1.7.0-result.json"
SOURCE_FILES = (
    ".dockerignore",
    ".env.example",
    "Dockerfile",
...
def main() -> int:
    ...
    staging = (ROOT / ".deploy-v1.7.0-staging").resolve()
    ...
    try:
        ...
        activated = True
        current_health = wait_health("1.7.0")
