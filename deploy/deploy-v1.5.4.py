...
NEW_IMAGE = "local/rds-binlog-insight:1.5.4"
BACKUP_IMAGE = "local/rds-binlog-insight:backup-v1.5.3-pre-v1.5.4"
RESULT_FILE = ROOT / "deploy-v1.5.4-result.json"
SOURCE_FILES = (
    ".dockerignore",
    ".env.example",
    "Dockerfile",
...
def main() -> int:
    ...
    staging = (ROOT / ".deploy-v1.5.4-staging").resolve()
    ...
    try:
        ...
        activated = True
        current_health = wait_health("1.5.4")
