...
NEW_IMAGE = "local/rds-binlog-insight:1.7.2"
BACKUP_IMAGE = "local/rds-binlog-insight:backup-v1.7.1-pre-v1.7.2"
RESULT_FILE = ROOT / "deploy-v1.7.2-result.json"
SOURCE_FILES = (
    ".dockerignore",
    ".env.example",
    "Dockerfile",
...
def main() -> int:
    ...
    staging = (ROOT / ".deploy-v1.7.2-staging").resolve()
    ...
    try:
        ...
        activated = True
        current_health = wait_health("1.7.2")
