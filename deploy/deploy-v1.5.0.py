...
CURRENT_IMAGE = "local/rds-binlog-insight:1.4.0"
NEW_IMAGE = "local/rds-binlog-insight:1.5.0"
BACKUP_IMAGE = "local/rds-binlog-insight:backup-v1.4.0-pre-v1.5.0"
RESULT_FILE = ROOT / "deploy-v1.5.0-result.json"
SOURCE_FILES = (
    ".dockerignore",
    ".env.example",
    "Dockerfile",
...
def main() -> int:
    ...
    staging = (ROOT / ".deploy-v1.5.0-staging").resolve()
    ...
    try:
        ...
        activated = True
        current_health = wait_health("1.5.0")
