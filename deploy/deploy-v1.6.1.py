...
NEW_IMAGE = "local/rds-binlog-insight:1.6.1"
BACKUP_IMAGE = "local/rds-binlog-insight:backup-v1.6.0-pre-v1.6.1"
RESULT_FILE = ROOT / "deploy-v1.6.1-result.json"
SOURCE_FILES = (
    ".dockerignore",
    ".env.example",
    "Dockerfile",
...
def main() -> int:
    ...
    staging = (ROOT / ".deploy-v1.6.1-staging").resolve()
    ...
    try:
        ...
        activated = True
        current_health = wait_health("1.6.1")
