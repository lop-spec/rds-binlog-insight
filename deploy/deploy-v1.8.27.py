...
CURRENT_VERSION = "1.8.26"
CURRENT_IMAGE = f"local/rds-binlog-insight:{CURRENT_VERSION}"
NEW_VERSION = "1.8.27"
NEW_IMAGE = f"local/rds-binlog-insight:{NEW_VERSION}"
BACKUP_IMAGE = "local/rds-binlog-insight:backup-v1.8.26-pre-v1.8.27"
RESULT_FILE = ROOT / "deploy-v1.8.27-result.json"
SOURCE_FILES = (
    ".dockerignore",
    ".env.example",
    "Dockerfile",
...
def main() -> int:
    ...
    staging = (ROOT / ".deploy-v1.8.27-staging").resolve()
